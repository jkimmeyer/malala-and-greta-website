  ...
  <div>
    <div class="m-auto max-w-screen-xl">
      <div class="grid">
        ...
        <div class="text text-right data-reveal-right" data-narrator-greta="a-lot-for-teenager">
          Bullet silence
        </div>
      </div>
    ...
    <div class="section">
      <div class="grid">
        <div class="text-3 col-4-6-s data-reveal-right data-narrator-house-on-fire">
